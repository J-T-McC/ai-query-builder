...
3. Review `.github/workflows/tests.yml` for dependency stability lanes, prefer-lowest coverage, and prefer-stable coverage. CI runs on ubuntu-latest only; Windows is intentionally unsupported in the matrix.
